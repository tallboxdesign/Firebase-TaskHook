...
export interface AppSettings {
  disableIncomingWebhookAuth: boolean;
}

export const DEFAULT_APP_SETTINGS: AppSettings = {
  disableIncomingWebhookAuth: false,
};
...
export interface SettingsValues {
  ...
  disableIncomingWebhookAuth?: boolean; // Added for disabling webhook auth
}
...
export const DEFAULT_SETTINGS: SettingsValues = {
  ...
  disableIncomingWebhookAuth: false, // Default to false
};
